...
| **19** | Marketplace | Later | Templates / checklists / connectors under tenant entitlements |
...
Do **not** build Phase 16B/17/18 product code in the 16A branch. Roadmap and Phase 18 **spec** documents are allowed so later work is not lost.
