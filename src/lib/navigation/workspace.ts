...
/** EHS workspace sidebar — operational modules only (no files app or org admin). */
export const WORKSPACE_NAV: AppModuleDef[] = [
  ...
  { key: "files", label: "Files & Data", href: "/app/files", icon: "Folder", featureCode: "document_control", permission: "documents.view", group: "assurance" },
  ...
  // Administration — org config links out to dedicated apps
  { key: "org-admin", label: "Org admin", href: "/org-admin", icon: "Building2", permission: "settings.manage", group: "administration" },
  { key: "settings", label: "EHS settings", href: "/app/settings/sites", icon: "Settings", permission: "settings.manage", group: "administration" },
