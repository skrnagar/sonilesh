...
export const APP_MODULES: AppModuleDef[] = [
  ...
  { key: "ai-copilot", label: "EHS Copilot", href: "/app/ai", icon: "Sparkles", featureCode: "ai_copilot", permission: "ai.use", group: "insights" },
  { key: "ai-actions", label: "AI suggestions", href: "/app/ai/actions", icon: "Sparkles", featureCode: "ai_copilot", permission: "ai.approve", group: "insights" },
  { key: "executive-copilot", label: "Executive Copilot", href: "/app/executive/copilot", icon: "Sparkles", featureCode: "ai_executive_copilot", permission: "ai.use", group: "insights" },
  ...
  { key: "executive", label: "Control Tower", href: "/app/executive", icon: "LayoutDashboard", featureCode: "executive_analytics", permission: "analytics.view", group: "insights" },
  { key: "alerts", label: "Alerts", href: "/app/alerts", icon: "Bell", featureCode: "advanced_analytics", permission: "analytics.view", group: "insights" },
  ...
  { key: "compliance-search", label: "Compliance search", href: "/app/compliance/search", icon: "Scale", featureCode: "regulatory_compliance", permission: "compliance.view", group: "compliance" },
  ...
  { key: "search", label: "Search", href: "/app/search", icon: "FileSearch", featureCode: "enterprise_search", permission: "search.use", group: "insights" },
  { key: "integrations", label: "Integrations", href: "/app/integrations", icon: "Puzzle", featureCode: "integrations", permission: "integrations.view", group: "system" },
  { key: "import", label: "Import", href: "/app/import", icon: "Inbox", permission: "import.manage", group: "system" },
  { key: "marketplace", label: "Marketplace", href: "/app/marketplace", icon: "Puzzle", featureCode: "marketplace", permission: "marketplace.view", group: "system" },
...
export const ADMIN_NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/ai/observability", label: "AI observability", icon: "Sparkles" },
