...
export const APP_MODULES: AppModuleDef[] = [
  ...
  { key: "esg-metrics", label: "ESG metrics", href: "/app/esg/metrics", icon: "Leaf", permission: "esg.view", group: "esg" },
  { key: "esg-ghg", label: "GHG inventory", href: "/app/esg/ghg-inventory", icon: "Leaf", permission: "esg.view", group: "esg" },
  { key: "esg-epr", label: "EPR", href: "/app/esg/epr", icon: "Recycle", permission: "esg.view", group: "esg" },
  { key: "esg-brsr", label: "BRSR report", href: "/app/esg/brsr-report", icon: "FileText", permission: "esg.view", group: "esg" },
  { key: "esg-materiality", label: "Materiality", href: "/app/esg/materiality", icon: "Grid2x2", permission: "esg.view", group: "esg" },
  { key: "esg-committee", label: "ESG committee", href: "/app/esg/committee", icon: "Users", permission: "esg.view", group: "esg" },
